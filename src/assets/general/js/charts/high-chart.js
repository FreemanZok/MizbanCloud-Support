...
(function (X, L) {
    ...
    L(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
        ...
        function c(b, d, g) {
            ...
            x(d)
                ? f(g)
                    ? b.setAttribute(d, g)
                    : b && b.getAttribute && ((k = b.getAttribute(d)) || "class" !== d || (k = b.getAttribute(d + "Name")))
                : J(d, function (d, g) {
                      b.setAttribute(g, d);
                  });
            return k;
        ...
        function l(b, d, g) {
            ...
            if ("width" === d)
                return (
                    ...
                    Math.max(0, d - (D(b, "padding-left", !0) || 0) - (D(b, "padding-right", !0) || 0))
                );
        ...
        function A(b, g, k, r) {
            ...
            if (d.createEvent && (b.dispatchEvent || (b.fireEvent && b !== a))) {
                ...
                D = [];
                for (var l = b, C = !1; l.hcEvents; ) Object.hasOwnProperty.call(l, "hcEvents") && l.hcEvents[g] && (D.length && (C = !0), D.unshift.apply(D, l.hcEvents[g])), (l = Object.getPrototypeOf(l));
                C &&
                    D.sort(function (b, z) {
        ...
        return {
            addEvent: function (b, d, g, k) {
                ...
                r[d] || (r[d] = []);
                r[d].push({ fn: g, order: "number" === typeof k.order ? k.order : Infinity });
            ...
            normalizeTickInterval: function (b, d, g, k, r) {
                ...
                var c = b / g;
                d ||
                    ((d = r ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
                    !1 === k &&
                        (1 === g
    ...
    L(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        u = (function () {
            ...
            u.prototype.init = function (a) {
                var B, q;
                if ((this.input = a = u.names[a && a.toLowerCase ? a.toLowerCase() : ""] || a) && a.stops)
    ...
    L(a, "Core/DefaultOptions.js", [a["Core/Globals.js"], a["Core/Chart/ChartDefaults.js"], a["Core/Color/Color.js"], a["Core/Color/Palette.js"], a["Core/Time.js"], a["Core/Utilities.js"]], function (a, u, E, H, x, y) {
        ...
        var h = {
            ...
            tooltip: {
                ...
                borderWidth: 1,
                shadow: !0,
                style: { color: H.neutralColor80, cursor: "default", fontSize: "12px", whiteSpace: "nowrap" },
            },
            credits: { enabled: !0, href: "http://www.highcharts.com?credits", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: H.neutralColor40, fontSize: "9px" }, text: "" },
        };
        ...
        return (function () {
            ...
            a.prototype.run = function (q, h, f) {
                ...
                q !== h || this.elem["forceAnimate:" + this.prop]
                    ? ((this.startTime = +new Date()), (this.start = q), (this.end = h), (this.unit = f), (this.now = this.start), (this.pos = 0), (t.elem = this.elem), (t.prop = this.prop), t() && 1 === a.timers.push(t) && m(w))
    ...
    L(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        u = (function () {
            ...
            c.allowedReferences = "http:// http:// mailto: / ../ ./ #".split(" ");
            return c;
        })();
        ("");
        return u;
    ...
    L(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Utilities.js"]], function (
        a,
        u,
        E,
        H,
        ...
        a = (function () {
                    ...
                    if (r) {
                        ...
                        if (l[h]) C = l[h].attr("id");
                            ...
                            e.forEach(function (b) {
                                ...
                                b = Q.createElement("stop").attr({ offset: b[0], "stop-color": f, "stop-opacity": p }).add(d);
                                d.stops.push(b);
                            });
                        }
                        t = "url(" + Q.url + "#" + C + ")";
            ...
            a.prototype.css = function (b) {
                ...
                if (a) {
                    ...
                    if (b)
                        ...
                        else if ("text" === k.nodeName.toLowerCase() && b.width) var I = (this.textWidth = C(b.width));
                    this.styles = b;
            ...
            a.prototype.destroy = function () {
                ...
                b.safeRemoveChild(d);
                for (g.styledMode || b.destroyShadows(); c && c.div && 0 === c.div.childNodes.length; ) (d = c.parentGroup), b.safeRemoveChild(c.div), delete c.div, (c = d);
            ...
            a.prototype.getBBox = function (d, g) {
                ...
                if (!f) {
                    ...
                    k.isSVG &&
                        ((d = f.width),
                        (k = f.height),
                        F && (f.height = k = { "11px,17": 14, "13px,20": 16 }[r && r.fontSize + "," + Math.round(k)] || k),
                        g && ((r = g * h), (f.width = Math.abs(k * Math.sin(r)) + Math.abs(d * Math.cos(r))), (f.height = Math.abs(k * Math.cos(r)) + Math.abs(d * Math.sin(r)))));
                    if (n && 0 < f.height) {
            ...
            a.prototype.shadow = function (b, d, g) {
                var k = [],
                    ...
                    r = { color: x.neutralColor100, offsetX: this.parentInverted ? -1 : 1, offsetY: this.parentInverted ? -1 : 1, opacity: 0.15, width: 3 },
                    a = !1,
                    l;
            ...
            a.prototype.strokeSetter = function (b, d, g) {
                ...
                this.stroke && this["stroke-width"]
                    ? (a.prototype.fillSetter.call(this, this.stroke, "stroke", g), g.setAttribute("stroke-width", this["stroke-width"]), (this.hasStroke = !0))
                    : "stroke-width" === d && 0 === b && this.hasStroke
                    ? (g.removeAttribute("stroke"), (this.hasStroke = !1))
                    : this.renderer.styledMode && this["stroke-width"] && (g.setAttribute("stroke-width", this["stroke-width"]), (this.hasStroke = !0));
            };
    ...
    L(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, u) {
        ...
        return (function (h) {
                ...
                if (w) {
                    var n = function (a) {
                        (("mouseenter" === c || "mouseleave" === c) &&
                            ...
                            (f.element.compareDocumentPosition(a.relatedTarget) & Node.DOCUMENT_POSITION_CONTAINED_BY || w.element.compareDocumentPosition(a.relatedTarget) & Node.DOCUMENT_POSITION_CONTAINED_BY)) ||
                            e.call(f.element, a);
                    };
                    w.on(c, n);
                }
            ...
            f.prototype.updateBoxSize = function () {
                ...
                this.needsBox &&
                    (this.box ||
                        ((h = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect()),
                        h.addClass(("button" === this.className ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")),
                        h.add(this)),
    ...
    L(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function (a) {
        ...
        return {
            ...
            callout: function (a, q, h, f, c) {
                ...
                a + m >= h
                    ? c > q + t && c < q + f - t
                        ? w.splice(3, 1, ["L", a + h, c - 6], ["L", a + h + 6, c], ["L", a + h, c + 6], ["L", a + h, q + f - e])
                        : w.splice(3, 1, ["L", a + h, f / 2], ["L", m, c], ["L", a + h, f / 2], ["L", a + h, q + f - e])
                    : 0 >= a + m
                    ? c > q + t && c < q + f - t
                        ? w.splice(7, 1, ["L", a, c + 6], ["L", a - 6, c], ["L", a, c - 6], ["L", a, q + e])
                        : w.splice(7, 1, ["L", a, f / 2], ["L", m, c], ["L", a, f / 2], ["L", a, q + e])
                    : c && c > f && m > a + t && m < a + h - t
                    ? w.splice(5, 1, ["L", m + 6, q + f], ["L", m, q + f + 6], ["L", m - 6, q + f], ["L", a + e, q + f])
                    : c && 0 > c && m > a + t && m < a + h - t && w.splice(1, 1, ["L", m - 6, q], ["L", m, q - 6], ["L", m + 6, q], ["L", h - e, q]);
                return w;
            },
            circle: function (a, q, h, f) {
                return v(a + h / 2, q + f / 2, h / 2, f / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 });
            },
        ...
        return (function () {
            ...
            h.prototype.buildSVG = function () {
                ...
                if (J !== f.textCache) {
                    ...
                    m || this.ellipsis || this.width || (-1 !== h.indexOf(" ") && (!this.noWrap || l.test(h)))
                        ? "" !== h &&
                          (e && e.appendChild(c),
                          (h = new a(h)),
                          ...
                          this.modifyDOM(),
                          this.ellipsis && -1 !== (c.textContent || "").indexOf("\u2026") && f.attr("title", this.unescapeEntities(f.textStr || "", ["&lt;", "&gt;"])),
                          e && e.removeChild(c))
            ...
            h.prototype.modifyDOM = function () {
                ...
                [].forEach.call(c.element.querySelectorAll("tspan.highcharts-br"), function (f, l) {
                    f.nextSibling && f.previousSibling && (0 === l && 1 === f.previousSibling.nodeType && (c.firstLineMetrics = c.renderer.fontMetrics(void 0, f.previousSibling)), y(f, { dy: a.getLineHeight(f.nextSibling), x: e }));
                });
                var h = this.width || 0;
                if (h) {
                    var m = function (f, l) {
                            ...
                            if (a.ellipsis)
                                n &&
                                    a.truncate(f, n, void 0, 0, Math.max(0, h - parseInt(a.fontSize || 12, 10)), function (b, d) {
                                        return b.substring(0, d) + "\u2026";
                                    });
                            else if (m) {
                                n = [];
                                for (m = []; l.firstChild && l.firstChild !== f; ) m.push(l.firstChild), l.removeChild(l.firstChild);
                                for (; w.length; )
                                    w.length && !a.noWrap && 0 < d && (n.push(f.textContent || ""), (f.textContent = w.join(" ").replace(/- /g, "-"))),
                                        a.truncate(f, void 0, w, 0 === d ? k || 0 : 0, h, function (b, d) {
                ...
                var f = this.svgElement,
                    ...
                    b = function (b, d) {
                        ...
                        if (g && "undefined" === typeof K[d])
                            ...
                            else l.getSpanWidth && ((a.textContent = w(c || e, b)), (K[d] = h + l.getSpanWidth(f, a)));
                        return K[d];
                    };
                f.rotation = 0;
        ...
        function (a, u, E, H, x, y, G, B, q, h) {
            ...
            E = (function () {
                ...
                z.prototype.init = function (b, d, g, a, r, c, z) {
                    var l = this.createElement("svg").attr({ version: "1.1", class: "highcharts-root" }),
                        Q = l.element;
                            ...
                            d = new a([
                                {
                                    ...
                                    children: [
                                        { tagName: "defs", children: [{ tagName: "clipPath", attributes: { id: d }, children: [{ tagName: "rect", attributes: { width: 4, height: 4 } }] }] },
                ...
                z.prototype.getStyle = function (b) {
                    return (this.style = r({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "12px" }, b));
                };
                ...
                z.prototype.button = function (b, d, g, k, c, z, l, e, f, F) {
                    ...
                    if (!Q) {
                        ...
                        var n = z.style;
                        delete z.style;
                        l = O(h, { fill: H.highlightColor10, style: { color: H.neutralColor100, fontWeight: "bold" } }, a.filterUserAttributes(l || {}));
                        var C = l.style;
                        delete l.style;
                ...
                z.prototype.rect = function (b, d, g, a, k, r) {
                    ...
                    b = M(b) ? b : "undefined" === typeof b ? {} : { x: b, y: d, width: Math.max(g, 0), height: Math.max(a, 0) };
                    ...
                    if (n) {
                        ...
                        ["width", "height"].forEach(function (d) {
                            w[d + "Setter"] = function (d, g) {
                                ...
                                this[g] = d;
                                b(a) &&
                                    (F && "within" === F.backgroundSize && this.width && this.height && (a = Math.round(a * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                                    this.element && this.element.setAttribute(g, a),
                                    this.alignByTranslate || ((d = ((this[g] || 0) - a) / 2), this.attr("width" === g ? { translateX: d } : { translateY: d })));
                            };
                        });
                        b(a) && w.attr({ x: a, y: c });
                        w.isImg = !0;
                ...
                z.prototype.text = function (d, g, a, k) {
                    ...
                    k ||
                        (d.xSetter = function (b, d, g) {
                            for (var a = g.getElementsByTagName("tspan"), k = g.getAttribute(d), r = 0, c; r < a.length; r++) (c = a[r]), c.getAttribute(d) === k && c.setAttribute(d, b);
                            g.setAttribute(d, b);
                        });
                    return d;
                };
                ...
                z.prototype.pathToSegments = function (b) {
                    for (var d = [], g = [], a = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, k = 0; k < b.length; k++)
            ...
            r(E.prototype, { Element: y, SVG_NS: l, escapes: { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#39;", '"': "&quot;" }, symbols: B, draw: n });
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === c.tagName) {
                        ...
                        F && (/[ \-]/.test(c.textContent || c.innerText) || "ellipsis" === c.style.textOverflow)
                            ? (q(c, { width: g + "px", display: "block", whiteSpace: k || "normal" }), (this.oldTextWidth = g), (this.hasBoxWidthChanged = !0))
                            : (this.hasBoxWidthChanged = !1);
                        r !== this.cTT &&
                            ((F = a.fontMetrics(c.style.fontSize, c).b),
                            !h(b) || (b === (this.oldRotation || 0) && p === this.oldAlign) || this.setSpanRotation(b, d, F),
                            this.getSpanCorrection((!h(b) && this.textPxLength) || c.offsetWidth, F, d, b, p));
                                ...
                                l.reverse().forEach(function (a) {
                                    ...
                                    d = a.div =
                                        ...
                                        G(
                                            ...
                                            { position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px", display: a.display, opacity: a.opacity, cursor: k.cursor, pointerEvents: k.pointerEvents },
                                            d || c
                                        );
                                    var e = d.style;
                                    B(a, {
    ...
    L(a, "Core/Axis/AxisDefaults.js", [a["Core/Color/Palette.js"]], function (a) {
        ...
        (function (v) {
            ...
            v.defaultTopAxisOptions = { labels: { autoRotation: [-45], x: 0 }, margin: 15, title: { rotation: 0 } };
        })(v || (v = {}));
        return v;
    });
    L(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        u = (function () {
            ...
            m.prototype.addLabel = function () {
                ...
                c.shortenLabel = u
                    ? function () {
                          for (M = 0; M < u.length; M++) if ((q(v, { dateTimeLabelFormat: u[M] }), D.attr({ text: W.call(v, v) }), D.getBBox().width < e.getSlotWidth(c) - 2 * k.padding)) return;
                          D.attr({ text: "" });
                      }
                    : void 0;
                F && e._addedPlotLB && c.moveLabel(l, k);
                G(D) || c.movedLabel
                    ? D && D.textStr !== l && !F && (!D.textWidth || k.style.width || D.styles.width || D.css({ width: null }), D.attr({ text: l }), (D.textPxLength = D.getBBox().width))
                    : ((c.label = D = c.createLabel({ x: 0, y: 0 }, l, k)), (c.rotation = 0));
            };
            ...
            m.prototype.getLabelPosition = function (a, c, l, e, f, m, p, d) {
                var k = this.axis,
                    ...
                    D = e || k.reserveSpaceDefault ? 0 : -k.labelOffset * ("center" === k.labelAlign ? 0.5 : 1),
                    n = {},
                    C = f.y;
            ...
            m.prototype.handleOverflow = function (a) {
                ...
                var d = this.label,
                    k = this.rotation,
                    b = { left: 0, center: 0.5, right: 1 }[c.labelAlign || d.attr("align")],
                    g = d.getBBox().width,
                ...
                if (k || "justify" !== l.overflow) 0 > k && e - b * g < p ? (C = Math.round(e / Math.cos(k * v) - p)) : 0 < k && e + b * g > h && (C = Math.round((f - e) / Math.cos(k * v)));
                    ...
                    ((f = e + (1 - b) * g),
                    e - b * g < p ? (D = a.x + D * (1 - b) - p) : f > h && ((D = h - a.x + D * b), (M = -1)),
                    (D = Math.min(r, D)),
                    D < r && "center" === c.labelAlign && (a.x += M * (r - D - b * (r - Math.min(g, D)))),
            ...
            m.prototype.renderGridLine = function (a, c, e) {
                ...
                g ||
                    (l.chart.styledMode || ((h.stroke = F), (h["stroke-width"] = r || 0), (h.dashstyle = D)),
                    d || (h.zIndex = 1),
                    a && (c = 0),
                    (this.gridLine = g = b
                        .path()
            ...
            m.prototype.renderMark = function (a, c, e) {
                ...
                d &&
                    ...
                    g[r ? "attr" : "animate"]({ d: this.getMarkPath(k, a, d[0], g.strokeWidth() * e, l.horiz, h), opacity: c }));
            };
            m.prototype.renderLabel = function (a, c, e, h) {
                ...
                d &&
                    ...
                    (this.isFirst && !this.isLast && !p.showFirstLabel) || (this.isLast && !this.isFirst && !p.showLastLabel) ? (r = !1) : !n || k.step || k.rotation || c || 0 === e || this.handleOverflow(a),
                    b && h % b && (r = !1),
                    r && f(a.y) ? ((a.opacity = e), d[this.isNewLabel ? "attr" : "animate"](a), (this.isNewLabel = !1)) : (d.attr("y", -9999), (this.isNewLabel = !0)));
            };
            ...
            a = (function () {
                ...
                a.prototype.setOptions = function (b) {
                    this.options = F(
                        ...
                        [B.defaultTopAxisOptions, B.defaultRightAxisOptions, B.defaultBottomAxisOptions, B.defaultLeftAxisOptions][this.side],
                        F(e[this.coll], b)
                    );
                ...
                a.prototype.defaultLabelFormatter = function (b) {
                    ...
                    else if (f && 1e3 <= z) for (; f-- && "undefined" === typeof h; ) (a = Math.pow(r, f + 1)), z >= a && 0 === (10 * d) % a && null !== l[f] && 0 !== d && (h = b(d / a, -1) + l[f]);
                        ...
                        b.series.forEach(function (d) {
                            if (d.visible || !a.options.chart.ignoreHiddenSeries) {
                                ...
                                if (b.isXAxis) {
                                    ...
                                    ((d = d.applyExtremes()),
                                    g(d.dataMin) && ((e = d.dataMin), (b.dataMin = Math.min(C(b.dataMin, e), e))),
                                    g(d.dataMax) && ((z = d.dataMax), (b.dataMax = Math.max(C(b.dataMax, z), z))),
                                    l(r) && (b.threshold = r),
                ...
                a.prototype.getMinorTickPositions = function () {
                    ...
                    if (k && k / d < this.len / 3) {
                        ...
                        else for (b = c + ((a[0] - c) % d); b <= g && b !== r[0]; b += d) r.push(b);
                    }
                ...
                a.prototype.setTickInterval = function (b) {
                    ...
                    p &&
                        l(a.dataMin) &&
                        ((q = q || 0),
                        !l(w) && a.min < q && a.dataMin >= q ? (a.min = a.options.minRange ? Math.min(q, a.max - a.minRange) : q) : !l(O) && a.max > q && a.dataMax <= q && (a.max = a.options.minRange ? Math.max(q, a.min + a.minRange) : q));
                    ...
                    a.tickInterval =
                        a.min === a.max || "undefined" === typeof a.min || "undefined" === typeof a.max
                            ? 1
                            : h && a.linkedParent && !t && F === a.linkedParent.options.tickPixelInterval
                            ? (t = a.linkedParent.tickInterval)
                            : C(t, this.tickAmount ? (a.max - a.min) / Math.max(this.tickAmount - 1, 1) : void 0, z ? 1 : ((a.max - a.min) * F) / Math.max(a.len, F));
                    f &&
                        !b &&
                    ...
                    a.dateTime || a.logarithmic || t || (a.tickInterval = D(a.tickInterval, void 0, k(a.tickInterval), C(e.allowDecimals, 0.5 > a.tickInterval || void 0 !== this.tickAmount), !!this.tickAmount));
                ...
                a.prototype.setScale = function () {
                    ...
                    g || b || a || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers()
                        ? (this.stacking && this.stacking.resetStacks(),
                          (this.forceRedraw = !1),
                          this.getSeriesExtremes(),
                          this.setTickInterval(),
                          this.isDirty || (this.isDirty = g || this.min !== (this.old && this.old.min) || this.max !== (this.old && this.old.max)))
                ...
                a.prototype.zoom = function (b, a) {
                    ...
                    d(this, "zoom", b, function (b) {
                        var a = b.newMin,
                            d = b.newMax;
                        if (a !== g.min || d !== g.max)
                            g.allowZoomOutside || (l(c) && (a < r && (a = r), a > f && (a = f)), l(k) && (d < r && (d = r), d > f && (d = f))),
                                (g.displayBtn = "undefined" !== typeof a || "undefined" !== typeof d),
                ...
                a.prototype.getExtremes = function () {
                    ...
                    return { min: b ? n(b.lin2log(this.min)) : this.min, max: b ? n(b.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
                };
                ...
                a.prototype.renderUnsquish = function () {
                    ...
                    if (this.autoRotation) C > f && C > F.h ? (h.rotation = this.labelRotation) : (this.labelRotation = 0);
                        ...
                        if (!D) {
                            ...
                            for (f = d.length; !e && f--; ) {
                                var n = d[f];
                                if ((n = g[n].label))
                                    n.styles && "ellipsis" === n.styles.textOverflow ? n.css({ textOverflow: "clip" }) : n.textPxLength > l && n.css({ width: l + "px" }),
                                        n.getBBox().height > this.len / d.length - (F.h - F.f) && (n.specificTextOverflow = "ellipsis");
                            }
                        }
                    }
                    h.rotation && ((p = C > 0.5 * b.chartHeight ? 0.33 * b.chartHeight : C), D || (M = "ellipsis"));
                    ...
                    d.forEach(function (b) {
                        ...
                        a &&
                            ...
                            b.shortenLabel
                                ? b.shortenLabel()
                                : p && !d && "nowrap" !== k.whiteSpace && (p < a.textPxLength || "SPAN" === a.element.tagName)
                                ? ((c.width = p + "px"), D || (c.textOverflow = a.specificTextOverflow || M), a.css(c))
                                : a.styles && a.styles.width && !c.width && !d && a.css({ width: null }),
                ...
                a.prototype.addTitle = function (b) {
                    var a = this.chart.renderer,
                        ...
                        e;
                    this.axisTitle ||
                        ((e = c.textAlign) || (e = (d ? { low: "left", middle: "center", high: "right" } : { low: g ? "right" : "left", middle: "center", high: g ? "left" : "right" })[c.align]),
                        (this.axisTitle = a
                ...
                a.prototype.getOffset = function () {
                    ...
                    if (!a.axisGroup) {
                        var J = function (a, d, g) {
                            return c
                                .g(a)
                                .attr({ zIndex: g })
                                .addClass("highcharts-" + b.coll.toLowerCase() + d + " " + (b.isRadial ? "highcharts-radial-axis" + d + " " : "") + (q || ""))
                                .add(w);
                        };
                    ...
                    D || a.isLinked
                        ? (e.forEach(function (b) {
                          ...
                          C(n.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
                              e.forEach(function (b) {
                ...
                a.prototype.getLinePath = function (b) {
                    ...
                    return a.renderer.crispLine(
                        [
                            ...
                            ["L", c ? a.chartWidth - this.right : k, c ? g : a.chartHeight - this.bottom],
                        ],
                        b
                    );
                };
                        ...
                        C &&
                            r.forEach(function (d, g) {
                                ...
                                0 === g % 2 &&
                                    ...
                                    (O = d + n),
                                    (D[d].options = { from: c ? c.lin2log(O) : O, to: c ? c.lin2log(A) : A, color: C, className: "highcharts-alternate-grid" }),
                                    D[d].render(),
                                    (D[d].isActive = !0));
                            });
                        b._addedPlotLB ||
                ...
                a.prototype.drawCrosshair = function (b, a) {
                    ...
                    if (g && !1 !== (l(a) || !c)) {
                        ...
                        r ||
                            ((this.cross = r = k.renderer
                                .path()
                                .addClass("highcharts-crosshair highcharts-crosshair-" + (c ? "category " : "thin ") + (g.className || ""))
                                .attr({ zIndex: C(g.zIndex, 2) })
                                .add()),
                            k.styledMode ||
                                (r.attr({ stroke: g.color || (c ? u.parse(E.highlightColor20).setOpacity(0.25).get() : E.neutralColor20), "stroke-width": C(g.width, 1) }).css({ "pointer-events": "none" }),
        ...
        var v = u.addEvent,
            ...
            G = (function () {
                ...
                a.prototype.getLogTickPositions = function (a, h, f, c) {
                    ...
                    if (0.5 <= a) (a = Math.round(a)), (w = e.getLinearTickPositions(a, h, f));
                    else if (0.08 <= a) {
                        var n = Math.floor(h),
                            l,
                            q = (m = void 0);
                        for (t = 0.3 < a ? [1, 2, 4] : 0.15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; n < f + 1 && !q; n++) {
                            var v = t.length;
                            for (l = 0; l < v && !q; l++) {
                        ...
                        (h = this.lin2log(h)),
                            ...
                            (a = y("auto" === a ? null : a, this.minorAutoInterval, ((m.tickPixelInterval / (c ? 5 : 1)) * (f - h)) / ((c ? t / e.tickPositions.length : t) || 1))),
                            (a = x(a, void 0, H(a))),
        ...
        var v = E.arrayMax,
            ...
            m = (function () {
                ...
                a.prototype.render = function () {
                    ...
                    l.chart.styledMode ||
                        (F
                            ? ((C.stroke = q || u.neutralColor40), (C["stroke-width"] = t(w.width, 1)), w.dashStyle && (C.dashstyle = w.dashStyle))
                            : r && ((C.fill = q || u.highlightColor10), w.borderWidth && ((C.stroke = w.borderColor), (C["stroke-width"] = w.borderWidth))));
                    B.zIndex = v;
                    z += "-" + v;
                    (m = l.plotLinesAndBandsGroups[z]) ||
                        (l.plotLinesAndBandsGroups[z] = m = x
                            .g("plot-" + z)
                            .attr(B)
                            .add());
                    ...
                    p && (y(p.text) || y(p.formatter)) && C && C.length && 0 < l.width && 0 < l.height && !C.isFlat
                        ? ((p = c({ align: f && r && "center", x: f ? !r && 4 : 10, verticalAlign: !f && r && "middle", y: f ? (r ? 16 : 10) : r ? 6 : -4, rotation: f && !r && 90 }, p)), this.renderLabel(p, C, r, v))
                        : d && d.hide();
                    return a;
                };
                a.prototype.renderLabel = function (a, c, e, f) {
                    ...
                    l ||
                        ((l = { align: a.textAlign || a.align, rotation: a.rotation, class: "highcharts-plot-" + (e ? "band" : "line") + "-label " + (a.className || "") }),
                        (l.zIndex = f),
        ...
        q(a.prototype, {
                ...
                if (e && l) {
                    ...
                    for (a = 0; a < e.length; a += 2) {
                        ...
                        ("M" !== c[0] && "L" !== c[0]) ||
                            ...
                            ("M" !== b[0] && "L" !== b[0]) ||
                            ("M" !== g[0] && "L" !== g[0]) ||
                            (m && b[1] === c[1] ? ((b[1] += p), (g[1] += p)) : m || b[2] !== c[2] || ((b[2] += p), (g[2] += p)), h.push(["M", c[1], c[2]], ["L", k[1], k[2]], ["L", g[1], g[2]], ["L", b[1], b[2]], ["Z"]));
                        h.isFlat = d;
                    }
                }
                return h;
            ...
            addPlotBandOrLine: function (a, c) {
                ...
                if (f) {
                    this._addedPlotLB ||
                        ((this._addedPlotLB = !0),
                        (h.plotLines || []).concat(h.plotBands || []).forEach(function (a) {
        ...
        a = (function () {
            ...
            a.prototype.getAnchor = function (a, c) {
                ...
                this.followPointer && c
                    ? ("undefined" === typeof c.chartX && (c = d.normalize(c)), (d = [c.chartX - f, c.chartY - e]))
                    : a[0].tooltipPos
                    ? (d = a[0].tooltipPos)
                    : (a.forEach(function (a) {
                      ...
                      this.shared && 1 < a.length && c && (k ? (d[0] = c.chartX - f) : (d[1] = c.chartY - e)));
            ...
            a.prototype.getLabel = function () {
                ...
                if (!this.label) {
                    ...
                    this.split
                        ? (this.label = c.g(e))
                        : ((this.label = c.label("", 0, 0, g.shape || "callout", null, null, g.useHTML, null, e).attr({ padding: g.padding, r: g.borderRadius })),
                          b || this.label.attr({ fill: g.backgroundColor, "stroke-width": g.borderWidth }).css(g.style).css({ pointerEvents: f }).shadow(g.shadow));
                ...
                var d = this.chart,
                    ...
                    n = function (g) {
                        ...
                        return [g, e ? p : m, e ? a : c].concat(
                            C
                                ? [e ? a * t.scaleX : c * t.scaleY, e ? t.left - k + (b.plotX + d.plotLeft) * t.scaleX : t.top - k + (b.plotY + d.plotTop) * t.scaleY, 0, e ? p : m]
                                : [e ? a : c, e ? b.plotX + d.plotLeft : b.plotY + d.plotTop, e ? d.plotLeft : d.plotTop, e ? d.plotLeft + d.plotWidth : d.plotTop + d.plotHeight]
                        );
                    },
                    q = n("y"),
                    w = n("x"),
            ...
            a.prototype.refresh = function (a, c) {
                ...
                if (d.enabled) {
                    ...
                    if (!1 === a) this.hide();
                        ...
                        else if (((k = q), (h = w), c && b.pointer.isDirectTouch && ((k = c.chartX - b.plotLeft), (h = c.chartY - b.plotTop)), b.polar || !1 === C.options.clip || C.shouldShowTooltip(k, h)))
                            (c = this.getLabel()),
                                (d.style.width && !m) || c.css({ width: this.chart.spacingBox.width + "px" }),
                                c.attr({ text: a && a.join ? a.join("") : a }),
                                c.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + l(f.colorIndex, C.colorIndex)),
                                m || c.attr({ stroke: d.borderColor || f.color || C.color || E.neutralColor60 }),
                                this.updatePosition({ plotX: q, plotY: w, negative: f.negative, ttBelow: f.ttBelow, h: n[2] || 0 });
                        else {
                            this.hide();
                            return;
                        }
                ...
                a = a.slice(0, k.length + 1).reduce(function (a, g, c) {
                    if (!1 !== g && "" !== g) {
                        ...
                        r ||
                            ...
                            (r = U.label("", 0, 0, y[h ? "headerShape" : "shape"] || "callout", void 0, void 0, y.useHTML)
                                .addClass((h ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + p)
                                .attr(r)
                                .add(P)));
                        r.isActive = !0;
                        r.attr({ text: g });
                        K ||
                            r
                                .css(y.style)
                                .shadow(y.shadow)
                                .attr({ stroke: y.borderColor || c.color || F.color || E.neutralColor80 });
                        f = f.tt = r;
                        h = f.getBBox();
                        ...
                        "number" === typeof D
                            ? ((h = h.height + 1),
                              ...
                              a.push({ align: I ? 0 : void 0, anchorX: F, anchorY: D, boxWidth: g, point: c, rank: l(p.rank, e ? 1 : 0), size: h, target: p.y, tt: f, x: p.x }))
                            : (f.isActive = !1);
                    }
                    return a;
                }, []);
        ...
        a = (function () {
                ...
                if (!J || !J.touch)
                    if ((w < f ? (w = f) : w > f + h && (w = f + h), A < l ? (A = l) : A > l + C && (A = l + C), (this.hasDragged = Math.sqrt(Math.pow(p - w, 2) + Math.pow(m - A, 2))), 10 < this.hasDragged)) {
                        ...
                        d.hasCartesianSeries &&
                            ...
                            !q &&
                            !J &&
                            ((this.selectionMarker = J = d.renderer
                                .rect(f, l, c ? 1 : h, e ? 1 : C, 0)
                                .attr({ class: "highcharts-selection-marker", zIndex: 7 })
                                .add()),
                            d.styledMode || J.attr({ fill: b.selectionMarkerFill || v(E.highlightColor80).setOpacity(0.25).get() }));
            ...
            a.prototype.onContainerClick = function (a) {
                ...
                d.cancelClick ||
                    (b && this.inClass(a.target, "highcharts-tracker")
                        ? (m(b.series, "click", e(a, { point: b })), d.hoverPoint && b.firePointEvent("click", a))
                        : (e(a, this.getCoordinates(a)), d.isInsidePlot(a.chartX - c, a.chartY - f, { visiblePlotOnly: !0 }) && m(d, "click", a)));
            };
            ...
            a.prototype.pinch = function (a) {
                ...
                "touchstart" === a.type
                    ...
                    : c.length && (n || (d.selectionMarker = n = e({ destroy: B, touch: !0 }, b.plotBox)), d.pinchTranslate(c, f, C, n, t, h), (d.hasPinched = p), d.scaleGroups(C, t), d.res && ((d.res = !1), this.reset(!1, 0)));
            };
            ...
            a.prototype.pinchTranslateDirection = function (a, c, b, g, e, f, l, h) {
                ...
                J ? ((A -= 0.8 * (A - l[k][0])), "number" === typeof v && (v -= 0.8 * (v - l[k][1])), c()) : (l[k] = [A, v]);
                D || ((f[k] = w - m), (f[p] = I));
                f = D ? 1 / P : P;
                e[p] = I;
                e[k] = b;
            ...
            a.prototype.runPointActions = function (d, c) {
                ...
                this.unDocMouseMove ||
                    ((this.unDocMouseMove = q(b.container.ownerDocument, "mousemove", function (b) {
            ...
            a.prototype.setDOMEvents = function () {
                ...
                for (var g = this.chart.renderTo.parentElement; g && "BODY" !== g.tagName; )
                    this.eventsToUnbind.push(
                        ...
                        (g = g.parentElement);
                u.hasTouch &&
                    (this.eventsToUnbind.push(q(c, "touchstart", this.onContainerTouchStart.bind(this), { passive: !1 })),
                    this.eventsToUnbind.push(q(c, "touchmove", this.onContainerTouchMove.bind(this), { passive: !1 })),
    ...
    L(a, "Core/MSPointer.js", [a["Core/Globals.js"], a["Core/Pointer.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        function x(a, c, e, f) {
            ...
            ("touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH) || !l || ((l = l.pointer), f(a), l[c]({ type: e, target: a.currentTarget, preventDefault: q, touches: v() }));
        }
        var y =
                (this && this.__extends) ||
                (function () {
    ...
    L(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"]], function (
        a,
        u,
        E,
        H,
        ...
        u = (function () {
            ...
            g.prototype.optionsToObject = function (a) {
                ...
                if (l(a) || null === a) b[e[0]] = a;
                    ...
                    for (!c && a.length > f && ((d = typeof a[0]), "string" === d ? (b.name = a[0]) : "number" === d && (b.x = a[0]), k++); h < f; )
            ...
            g.prototype.update = function (a, b, d, c) {
                function g() {
                    ...
                    J(a, !0) &&
                        (k && k.element && a && a.marker && "undefined" !== typeof a.marker.symbol && (e.graphic = k.destroy()),
                ...
                d.firePointEvent(a ? "select" : "unselect", { accumulate: b }, function () {
                    ...
                    b ||
                        g.getSelectedPoints().forEach(function (a) {
                            ...
                            a.selected &&
                                a !== d &&
                                ((a.selected = a.options.selected = !1), (b.options.data[b.data.indexOf(a)] = a.options), a.setState(g.hoverPoints && b.options.inactiveOtherPoints ? "inactive" : ""), a.firePointEvent("unselect"));
                        });
                });
                ...
                if (!((b === this.state && !d) || (this.selected && "select" !== b) || !1 === f.enabled || (b && (m || (h && !1 === r.enabled))) || (b && F.states && F.states[b] && !1 === F.states[b].enabled))) {
                    ...
                    f && f.size && n && "hidden" !== A && !this.isCluster
                        ? (v || (c.halo = v = w.renderer.path().add(n.parentGroup)),
                          ...
                          v.attr({ class: "highcharts-halo highcharts-color-" + p(this.colorIndex, c.colorIndex) + (this.className ? " " + this.className : ""), visibility: A, zIndex: -1 }),
                          (v.point = this),
                          w.styledMode || v.attr(e({ fill: this.color || c.color, "fill-opacity": f.opacity }, a.filterUserAttributes(f.attributes || {}))))
    ...
    L(a, "Core/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, u, E, H, x) {
        ...
        var d = (function () {
            ...
            a.prototype.positionItem = function (a) {
                ...
                h &&
                    h.element &&
                    ((c = { translateX: f ? d : this.legendWidth - d - 2 * c - 4, translateY: k }),
                    (f = function () {
            ...
            a.prototype.renderItem = function (a) {
                ...
                t ||
                    ((a.legendGroup = d
                        .g("legend-item")
                        .addClass("highcharts-" + q.type + "-series highcharts-color-" + a.colorIndex + (u ? " " + u : "") + (n ? " highcharts-series-" + a.index : ""))
                        .attr({ zIndex: 1 })
                        .add(this.scrollGroup)),
                    (a.legendItem = t = d.text("", m ? e + f : -f, this.baseline || 0, A)),
                    b.styledMode || t.css(l(a.visible ? k : h)),
                    t.attr({ align: m ? "left" : "right", zIndex: 2 }).add(a.legendGroup),
                    this.baseline ||
                        ((this.fontMetrics = d.fontMetrics(b.styledMode ? 12 : k.fontSize, t)),
                        ...
                        c.squareSymbol && ((this.symbolWidth = J(c.symbolWidth, Math.max(this.symbolHeight, 16))), (w = this.symbolWidth + f + p + (v ? 20 : 0)), m && t.attr("x", this.symbolWidth + f))),
            ...
            a.prototype.adjustMargins = function (a, d) {
                var b = this.chart,
                    ...
                    g = this.getAlignment();
                g &&
                    [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (f, k) {
            ...
            a.prototype.proximatePositions = function () {
                ...
                this.allItems.forEach(function (b) {
                    ...
                    if (b.yAxis) {
                        ...
                        b.points &&
                            (e = m(g ? b.points : b.points.slice(0).reverse(), function (a) {
                                return n(a.plotY);
                            }));
                        g = this.itemMarginTop + b.legendItem.getBBox().height + this.itemMarginBottom;
                        var f = b.yAxis.top - a.plotTop;
                        b.visible ? ((e = e ? e.plotY : b.yAxis.height), (e += f - 0.3 * g)) : (e = f + b.yAxis.height);
            ...
            a.prototype.render = function () {
                ...
                0 < h && 0 < m && (e[e.isNew ? "attr" : "animate"](e.crisp.call({}, { x: 0, y: 0, width: h, height: m }, e.strokeWidth())), (e.isNew = !1));
                e[l ? "show" : "hide"]();
            ...
            a.prototype.handleOverflow = function (a) {
                ...
                var l = e.maxHeight,
                    ...
                    A = this.allItems,
                    I = function (a) {
                        "number" === typeof a ? m.attr({ height: a }) : m && ((b.clipRect = m.destroy()), b.contentGroup.clip());
                ...
                a && 0 < f && a > f && !1 !== p.enabled
                    ? ((this.clipHeight = h = Math.max(f - 20 - this.titleHeight - k, 0)),
                      ...
                      b.scroll(0),
                      (a = f))
                    : w && (I(), (this.nav = w.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
                return a;
            };
            a.prototype.scroll = function (a, d) {
                ...
                0 < f &&
                    ...
                    [this.down, this.downTracker].forEach(function (a) {
                        a.attr({ x: 18 + this.pager.getBBox().width, class: f === g ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                    }, this),
                    c.styledMode ||
                        (this.up.attr({ fill: 1 === f ? k.inactiveColor : k.activeColor }),
                        this.upTracker.css({ cursor: 1 === f ? "default" : "pointer" }),
                        this.down.attr({ fill: f === g ? k.inactiveColor : k.activeColor }),
                        this.downTracker.css({ cursor: f === g ? "default" : "pointer" })),
            ...
            a = (function () {
                ...
                a.prototype.isInsidePlot = function (a, b, d) {
                    ...
                    !d.ignoreY &&
                        ...
                        (d >= Math.max(h + f, c.pos) && d <= Math.min(h + f + e.height, c.pos + c.len)) || (a.isInsidePlot = !1));
                ...
                a.prototype.layOutTitles = function (a) {
                    ...
                    ["title", "subtitle", "caption"].forEach(function (a) {
                        ...
                        if (e) {
                            ...
                            e.align(z({ y: "bottom" === f ? k : a + k, height: l }, g), !1, "spacingBox");
                ...
                a.prototype.temporaryDisplay = function (a) {
                    var b = this.renderTo;
                    if (a) for (; b && b.style; ) b.hcOrigStyle && (O(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (p.body.removeChild(b), (b.hcOrigDetached = !1)), (b = b.parentNode);
                    else
                        for (; b && b.style; ) {
                ...
                a.prototype.getContainer = function () {
                    ...
                    if (this.styledMode) for (var h in a.defs) this.renderer.definition(a.defs[h]);
                ...
                a.prototype.propFromSeries = function () {
                    ...
                    ["inverted", "angular", "polar"].forEach(function (f) {
                        ...
                        for (c = d && d.length; !g && c--; ) (e = r[d[c].type]) && e.prototype[f] && (g = !0);
                        a[f] = g;
                    });
                };
                a.prototype.linkSeries = function () {
                    ...
                    b.forEach(function (b) {
                        ...
                        P(d) &&
                            ...
                            d.linkedParent !== b &&
                            (d.linkedSeries.push(b), (b.linkedParent = d), d.enabledDataSorting && b.setDataSortingOptions(), (b.visible = R(b.options.visible, d.options.visible, b.visible)));
                    });
                ...
                a.prototype.showLoading = function (a) {
                    var b = this,
                        ...
                        c = d.loading,
                        e = function () {
                            g && O(g, { left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px" });
                        },
                        g = b.loadingDiv,
                        f = b.loadingSpan;
                    ...
                    b.styledMode || (O(g, z(c.style, { zIndex: 10 })), O(f, c.labelStyle), b.loadingShown || (O(g, { opacity: 0, display: "" }), w(g, { opacity: c.style.opacity || 0.5 }, { duration: c.showDuration || 0 })));
                    b.loadingShown = !0;
                    e();
                };
                            ...
                            if (b.options.panningEnabled && !b.options.isInternal) {
                                ...
                                b.isOrdinal ||
                                    ...
                                    b.series.length &&
                                        ...
                                        h >= p &&
                                        t <= n &&
                                        (b.setExtremes(h, t, !1, !1, { trigger: "pan" }), d.resetZoomButton || g || h === p || t === n || !f.match("y") || (d.showResetZoom(), (b.displayBtn = !1)), (k = !0)),
                                    (e[c] = l));
                            }
                        });
                        T(e, function (a, b) {
        ...
        return (a.LegendSymbolMixin = {
            drawRectangle: function (a, v) {
                ...
                v.legendSymbol = this.chart.renderer
                    .rect(B ? (a.symbolWidth - u) / 2 : 0, a.baseline - u + 1, B ? u : a.symbolWidth, u, H(a.options.symbolRadius, u / 2))
            ...
            drawLineMarker: function (a) {
                ...
                x &&
                    ...
                    0 === this.symbol.indexOf("url") && ((x = v(x, { width: q, height: q })), (u = 0)),
                    (this.legendSymbol = x = f
            ...
            a = (function () {
                ...
                a.prototype.setOptions = function (a) {
                    ...
                    (!g.negativeColor && !g.negativeFillColor) ||
                        g.zones ||
                        ((e = { value: g[this.zoneAxis + "Threshold"] || g.threshold || 0, className: "highcharts-negative" }), d || ((e.color = g.negativeColor), (e.fillColor = g.negativeFillColor)), c.push(e));
                    ...
                    a.forEach(function (a, d) {
                        ...
                        if (l.id || S(m)) {
                            if (
                                ...
                                -1 === m || "undefined" === typeof m ? f.push(a) : g[m] && a !== c.data[m] ? (g[m].update(a, !1, null, !1), (g[m].touched = !0), r && (h = m + 1)) : g[m] && (g[m].touched = !0),
                                !p || d !== m || (e && e.enabled) || this.hasDerivedData)
                            )
                                k = !0;
                        } else f.push(a);
                    }, this);
                    if (k) for (a = g.length; a--; ) (l = g[a]) && !l.touched && l.remove && l.remove(!1, d);
                    else
                        !p || (e && e.enabled)
                            ? (m = !1)
                            : (a.forEach(function (a, b) {
                ...
                a.prototype.setData = function (a, b, d, c) {
                    ...
                    if (!C) {
                        ...
                        if (m && k > m)
                            if (((m = e.getFirstValidPoint(a)), S(m))) for (d = 0; d < k; d++) (I[d] = this.autoIncrement()), (n[d] = a[d]);
                            else if (O(m))
                                if (q) for (d = 0; d < k; d++) (c = a[d]), (I[d] = c[0]), (n[d] = c.slice(1, q + 1));
                                else for (w && ((A = w.indexOf("x")), (v = w.indexOf("y")), (A = 0 <= A ? A : 0), (v = 0 <= v ? v : 1)), d = 0; d < k; d++) (c = a[d]), (I[d] = c[A]), (n[d] = c[v]);
                            else r(12, !1, h);
                        else for (d = 0; d < k; d++) "undefined" !== typeof a[d] && ((c = { series: e }), e.pointClass.prototype.applyOptions.apply(c, [a[d]]), e.updateParallelArrays(c, d));
                        n && W(n[0]) && r(14, !0, h);
                        e.data = [];
                ...
                a.prototype.getClipBox = function (a, b) {
                    ...
                    a && !1 === d.clip && f
                        ? (a = e ? { y: -c.chartWidth + f.len + f.pos, height: c.chartWidth, width: c.chartHeight, x: -c.chartHeight + g.len + g.pos } : { y: -f.pos, height: c.chartHeight, width: c.chartWidth, x: -g.pos })
                ...
                a.prototype.setClip = function (a) {
                    ...
                    l
                        ...
                        : (a && (b.sharedClips[k + "m"] = h = c.clipRect(e ? (b.plotSizeX || 0) + 99 : -99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)),
                            ...
                            if (((k && "undefined" === typeof p.enabled) || p.enabled) && !l.isNull && !1 !== l.visible) {
                                ...
                                c
                                    ...
                                    : n &&
                                      ...
                                      ((l.graphic = c = b.renderer.symbol(m, t.x, t.y, t.width, t.height, r ? p : e).add(g)), this.enabledDataSorting && b.hasRendered && (c.attr({ x: l.startXPos }), (h = "animate")));
                ...
                a.prototype.redraw = function () {
                    var a = this.chart,
                        ...
                        c = this.xAxis,
                        e = this.yAxis;
                    d && (a.inverted && d.attr({ width: a.plotWidth, height: a.plotHeight }), d.animate({ translateX: z(c && c.left, a.plotLeft), translateY: z(e && e.top, a.plotTop) }));
                    this.translate();
                    this.render();
                ...
                a.prototype.buildKDTree = function (a) {
                    function b(a, c, e) {
                        ...
                        if ((g = a && a.length)) {
                            ...
                            g = Math.floor(g / 2);
                            return { point: a[g], left: b(a.slice(0, g), c + 1, e), right: b(a.slice(g + 1), c + 1, e) };
                        }
                    }
                    ...
                    l
                        ...
                        : a.graph &&
                          ((a.tracker = f
                              ...
                              .add(a.group)),
                          e.styledMode || a.tracker.attr({ "stroke-linecap": "round", "stroke-linejoin": "round", stroke: p, fill: d ? p : "none", "stroke-width": a.graph.strokeWidth() + (d ? 0 : 2 * k) }),
                ...
                a.prototype.update = function (a, b) {
                    ...
                    a = Y(g, q, { index: "undefined" === typeof g.index ? c.index : g.index, pointStart: z(k && k.series && k.series.pointStart, g.pointStart, c.xData[0]) }, !p && { data: c.options.data }, a);
                    ...
                    if (p && this.points) {
                        ...
                        !1 === A.visible
                            ...
                            : c._hasPointLabels || ((a = A.marker), (h = A.dataLabels), a && (!1 === a.enabled || "symbol" in a) && (w.graphic = 1), h && !1 === h.enabled && (w.dataLabel = 1));
                ...
                a.prototype.setState = function (a, b) {
                    ...
                    if (
                        ...
                        if (e && !e.dashstyle) for (f = { "stroke-width": k }, e.animate(f, h); d["zone-graph-" + c]; ) d["zone-graph-" + c].animate(f, h), (c += 1);
                        g ||
        ...
        function (a, u, E, H, x, y) {
            ...
            B(E, "afterSetChartSize", function (a) {
                ...
                if (!this.renderer.forExport) {
                    if (f) {
                        ...
                        c &&
                            (this.scrollablePixelsY = f = Math.max(0, c - this.chartHeight)) &&
                            ((this.scrollablePlotBox = this.renderer.scrollablePlotBox = h(this.plotBox)),
            ...
            E.prototype.moveFixedElements = function () {
                ...
                this.scrollablePixelsX && !this.inverted
                    ...
                    ? (h = ".highcharts-xaxis")
                    : this.scrollablePixelsY && this.inverted && (h = ".highcharts-yaxis");
            ...
            E.prototype.applyFixed = function () {
                var a = !this.fixedDiv,
                    ...
                    m = x.getRendererType();
                a
                    ? ((this.fixedDiv = q("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: ((e.style && e.style.zIndex) || 0) + 2, top: 0 }, null, !0)),
                      ...
                      (this.scrollableMask = e
                          .path()
                          .attr({ fill: this.options.chart.backgroundColor || "#fff", "fill-opacity": f(h.opacity, 0.85), zIndex: -1 })
                ...
                a = this.scrollablePixelsX
                    ? [["M", 0, a], ["L", this.plotLeft - 1, a], ["L", this.plotLeft - 1, e], ["L", 0, e], ["Z"], ["M", w, a], ["L", this.chartWidth, a], ["L", this.chartWidth, e], ["L", w, e], ["Z"]]
                    : this.scrollablePixelsY
                    ? [["M", h, 0], ["L", h, this.plotTop - 1], ["L", m, this.plotTop - 1], ["L", m, 0], ["Z"], ["M", h, n], ["L", h, this.chartHeight], ["L", m, this.chartHeight], ["L", m, n], ["Z"]]
                    : [["M", 0, 0]];
        ...
        var v = a.getDeferredAnimation,
            ...
            q = (function () {
                ...
                a.prototype.renderStackTotals = function () {
                    ...
                    var m = (this.stackTotalGroup = this.stackTotalGroup || e.g("stack-labels").attr({ visibility: "visible", zIndex: 6, opacity: 0 }).add());
    ...
    L(a, "Extensions/Stacking.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Axis/StackingAxis.js"], a["Core/Utilities.js"]], function (
        a,
        u,
        E,
        H,
            ...
            w = (function () {
                ...
                a.prototype.render = function (a) {
                    ...
                    this.label
                        ...
                        : ((this.label = c.renderer.label(f, null, null, e.shape, null, null, e.useHTML, !1, "stack-labels")),
                          (f = { r: e.borderRadius || 0, text: f, rotation: e.rotation, padding: m(e.padding, 5), visibility: "hidden" }),
                          c.styledMode || ((f.fill = e.backgroundColor), (f.stroke = e.borderColor), (f["stroke-width"] = e.borderWidth), this.label.css(e.style)),
                          this.label.attr(f),
                ...
                a.prototype.setOffset = function (a, c, f, n, p) {
                    ...
                    c &&
                        ...
                        ((p = c.getBBox()),
                        (n = c.padding),
                        (b = "left" === b ? (k.inverted ? -n : n) : "right" === b ? p.width : k.inverted && "center" === b ? p.width / 2 : k.inverted ? (f ? p.width + n : -n) : p.width / 2),
                        ...
                        k.isInsidePlot(c.alignAttr.x + b - this.alignOptions.x, c.alignAttr.y + f - this.alignOptions.y) ? c.show() : ((c.alignAttr.y = -9999), (a = !1)),
                        a && x.prototype.justifyDataLabel.call(this.axis, c, this.alignOptions, c.alignAttr, p, d),
                ...
                for (x = 0; x < p; x++) {
                    ...
                    null !== E
                        ? ((z.points[H] = z.points[this.index] = [m(z.cumulative, b)]),
                          ...
                          0 < G.index && !1 === this.singleStacks && (z.points[H][0] = z.points[this.index + "," + y + ",0"][0]))
                        : (z.points[H] = z.points[this.index] = null);
                    "percent" === e
                        ? ((C = C ? a : g), r && u[C] && u[C][y] ? ((C = u[C][y]), (z.total = C.total = Math.max(C.total, z.total) + Math.abs(E) || 0)) : (z.total = q(z.total + (Math.abs(E) || 0))))
                        : "group" === e
                        ? (c(E) && (E = E[0]), null !== E && (z.total = (z.total || 0) + 1))
            ...
            q.prototype.drawGraph = function () {
                ...
                t.forEach(function (a, t) {
                    var m = a[0],
                        l = h[m],
                        q = l ? "animate" : "attr";
                    l ? ((l.endX = h.preventGraphAnimation ? null : c.xMap), l.animate({ d: c })) : c.length && (h[m] = l = h.chart.renderer.path(c).addClass(a[1]).attr({ zIndex: 1 }).add(h.group));
                    l &&
                        !e &&
                        ((m = { stroke: a[2], "stroke-width": f.lineWidth, fill: (h.fillGraph && h.color) || "none" }),
                        a[3] ? (m.dashstyle = a[3]) : "square" !== f.linecap && (m["stroke-linecap"] = m["stroke-linejoin"] = "round"),
        ...
        H = (function (a) {
            ...
            c.prototype.drawGraph = function () {
                ...
                q.forEach(function (a) {
                    ...
                    c.chart.styledMode || (q.fill = h(a[3], y(a[2]).setOpacity(h(m.fillOpacity, 0.75)).get()));
                    t[n](q);
                    t.startX = f.xMap;
        ...
        function (a, u, E, H, x, y, G, B) {
            ...
            B = (function (a) {
                ...
                d.prototype.animate = function (a) {
                    ...
                    if (a) (k.scaleY = 0.001), (a = e(d.toPixels(c.threshold), d.pos, d.pos + d.len)), f ? (k.translateX = a - d.len) : (k.translateY = a), b.clipBox && b.setClip(), b.group.attr(k);
                    else {
                ...
                d.prototype.translate = function () {
                    ...
                    a.points.forEach(function (b) {
                        ...
                        b.tooltipPos = d.inverted
                            ? [e(l.len + l.pos - d.plotLeft - g, l.pos - d.plotLeft, l.len + l.pos - d.plotLeft), k.len + k.pos - d.plotTop - C - F / 2, z]
                            : [k.left - d.plotLeft + C + F / 2, e(g + l.pos - d.plotTop, l.pos - d.plotTop, l.len + l.pos - d.plotTop), z];
                ...
                d.prototype.pointAttribs = function (a, d) {
                    ...
                    d &&
                        a &&
                        ((a = K(b.states[d], (a.options.states && a.options.states[d]) || {})),
                        (d = a.brightness),
                        (k = a.color || ("undefined" !== typeof d && f(k).brighten(a.brightness).get()) || k),
                        (l = a[e] || l),
                        (h = a[g] || h),
                        (c = a.dashStyle || c),
                        (p = A(a.opacity, p)));
                ...
                d.prototype.drawPoints = function () {
                    ...
                    a.points.forEach(function (b) {
                        ...
                        if (J(b.plotY) && null !== b.y) {
                            ...
                            g || ((b.graphic = g = e[b.shapeType](k).add(b.group || a.group)) && a.enabledDataSorting && d.hasRendered && d.pointCount < f && (g.attr({ x: b.startXPos }), (l = !0), (h = "animate")));
                            if (g && l) g[h](K(k));
                ...
                d.defaultOptions = K(y.defaultOptions, {
                    ...
                    cropThreshold: 50,
                    pointRange: null,
                    states: { hover: { halo: !1, brightness: 0.1 }, select: { color: x.neutralColor20, borderColor: x.neutralColor100 } },
    ...
    L(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, u, E) {
        ...
        E = (function (a) {
            ...
            c.prototype.setVisible = function (a, c) {
                ...
                c = q(c, l);
                a !== e.visible &&
                    ((e.visible = e.options.visible = a = "undefined" === typeof a ? !e.visible : a),
            ...
            h = (function (a) {
                ...
                h.prototype.redrawPoints = function () {
                    ...
                    a.points.forEach(function (g) {
                        ...
                        if (!g.isNull && b) {
                            ...
                            g.delayedRendering
                                ? (b.setRadialReference(a.center).attr(h).attr(e), c.styledMode || b.attr(f).attr({ "stroke-linejoin": "round" }).shadow(l, p), (g.delayedRendering = !1))
                                : (b.setRadialReference(a.center), c.styledMode || v(!0, k, f), v(!0, k, h, e), b.animate(k));
                ...
                h.prototype.translate = function (a) {
                    ...
                    for (v = 0; v < u; v++) {
                        ...
                        w.labelPosition = {
                            natural: { x: a[0] + y + Math.cos(x) * w.labelDistance, y: a[1] + B + Math.sin(x) * w.labelDistance },
                            final: {},
                            alignment: 0 > w.labelDistance ? "center" : w.half ? "right" : "left",
                            connectorPosition: { breakAt: { x: a[0] + y + Math.cos(x) * A, y: a[1] + B + Math.sin(x) * A }, touchingSliceAt: { x: a[0] + y, y: a[1] + B } },
                        };
                    }
                    m(this, "afterTranslate");
                };
    ...
    L(
        ...
        [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Color/Palette.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]],
        function (a, u, E, H, x, y, G) {
            ...
            E.distribute = function (a, c, e) {
                ...
                for (
                    ...
                    for (d = a.length; d--; ) (k = a[d]), (p = (Math.min.apply(0, k.targets) + Math.max.apply(0, k.targets)) / 2), (k.pos = f(p - k.size * k.align, 0, c - k.size));
                    d = a.length;
                    for (k = !1; d--; )
                        0 < d &&
                            ...
                            (a[d - 1].align = 0.5),
                            a[d - 1].pos + a[d - 1].size > c && (a[d - 1].pos = c - a[d - 1].size),
                            a.splice(d, 1),
                            (k = !0));
                }
                h.push.apply(h, m);
                ...
                a.some(function (a) {
                    ...
                    if (
                        a.targets.some(function () {
                            h[d].pos = a.pos + b;
                            if ("undefined" !== typeof e && Math.abs(h[d].pos - h[d].target) > e)
                                return (
                ...
                function a(a, b) {
                    ...
                    return c
                        ? ((b = c.operator),
                          (a = a[c.property]),
                          (c = c.value),
                          (">" === b && a > c) || ("<" === b && a < c) || (">=" === b && a >= c) || ("<=" === b && a <= c) || ("==" === b && a == c) || ("===" === b && a === c) ? !0 : !1)
                        : !0;
                }
                function d(a, b) {
                    var c = [],
                    ...
                    else if (m(a) || m(b)) for (d = Math.max(a.length, b.length); d--; ) c[d] = w(a[d], b[d]);
                    else c = w(a, b);
                    return c;
                }
                var e = this,
                        ...
                        x.forEach(function (d, k) {
                            ...
                            if (h) {
                                ...
                                b.styledMode ||
                                    ...
                                    "contrast" === u.color ? ((g.contrastColor = y.getContrast(g.color || e.color)), (u.color = (!c(r) && d.inside) || 0 > r || f.stacking ? g.contrastColor : H.neutralColor100)) : delete g.contrastColor,
                                ...
                                ? h &&
                                  ...
                                  (m
                                      ...
                                      : ((g.dataLabels = g.dataLabels || []),
                                        (m = g.dataLabels[k] = w ? y.text(v, 0, -9999, d.useHTML).addClass("highcharts-data-label") : y.label(v, 0, -9999, d.shape, null, null, d.useHTML, null, "data-label")),
                                        k || (g.dataLabel = m),
                                        m.addClass(" highcharts-data-label-color-" + g.colorIndex + " " + (d.className || "") + (d.useHTML ? " highcharts-tracker" : ""))),
                                  (m.options = d),
                                  m.attr(x),
                                  b.styledMode || m.css(u).shadow(d.shadow),
                                  m.added || m.add(B),
                                  d.textPath && !d.useHTML && (m.setTextPath((g.getDataLabelPath && g.getDataLabelPath(m)) || g.graphic, d.textPath), g.dataLabelPath && !d.textPath.enabled && (g.dataLabelPath = g.dataLabelPath.destroy())),
                                  e.alignDataLabel(g, m, d, null, t))
                                : ((g.dataLabel = g.dataLabel && g.dataLabel.destroy()),
                                  g.dataLabels && (1 === g.dataLabels.length ? delete g.dataLabels : delete g.dataLabels[k]),
                                  k || delete g.dataLabel,
                                  p && ((g.connector = g.connector.destroy()), g.connectors && (1 === g.connectors.length ? delete g.connectors : delete g.connectors[k])));
                        });
                    });
                }
            ...
            x.prototype.alignDataLabel = function (a, c, f, b, g) {
                var d = this,
                    ...
                    x =
                        this.visible &&
                        !1 !== a.visible &&
                        (a.series.forceDL || (m && !w) || u || (l(f.inside, !!this.options.stacking) && b && k.isInsidePlot(p, h ? b.x + 1 : b.y + b.height - 1, { inverted: h, paneCoordinates: !0, series: d })));
                var A = function (b) {
                ...
                if (x) {
                    ...
                    t
                        ? ((w = !1),
                          ...
                          (p = { x: b.x + (f.x || 0) + b.width / 2 + p.x, y: b.y + (f.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[f.verticalAlign] * b.height }),
                          A(p),
                          c[g ? "attr" : "animate"](p).attr({ align: v }),
                          (A = (t + 720) % 360),
                          (A = 180 < A && 360 > A),
                          "left" === v ? (p.y -= A ? q.height : 0) : "center" === v ? ((p.x -= q.width / 2), (p.y -= q.height / 2)) : "right" === v && ((p.x -= q.width), (p.y -= A ? 0 : q.height)),
                          (c.placed = !0),
                          (c.alignAttr = p))
                        : (A(b), c.align(f, void 0, b), (p = c.alignAttr));
                    w && 0 <= b.height
                        ? this.justifyDataLabel(c, f, p, q, b, g)
                        : l(f.crop, !0) && (x = k.isInsidePlot(p.x, p.y, { paneCoordinates: !0, series: d }) && k.isInsidePlot(p.x + q.width, p.y + q.height, { paneCoordinates: !0, series: d }));
                    if (f.shape && !t) c[g ? "attr" : "animate"]({ anchorX: h ? k.plotWidth - a.plotY : a.plotX, anchorY: h ? k.plotHeight - a.plotX : a.plotY });
                }
                g && m && (c.placed = !1);
            ...
            x.prototype.setDataLabelStartPos = function (a, c, e, b, f) {
                ...
                d.hasRendered && (e && c.attr({ x: c.startXPos, y: c.startYPos }), (c.placed = !0));
            };
                            ...
                            if (h) {
                                ...
                                if (0 < a.maxLabelDistance) {
                                    ...
                                    d.forEach(function (a) {
                                        0 < a.labelDistance &&
                                            ...
                                            (a.bottom = Math.min(G + B + a.labelDistance, b.plotHeight)),
                                            (p = a.dataLabel.getBBox().height || 21),
                                            (a.distributeBox = { target: a.labelPosition.natural.y - a.top + p / 2, size: p, rank: a.y }),
                                ...
                                for (U = 0; U < h; U++) {
                                    ...
                                    l(f.crop, !0) &&
                                        ((J = z.getBBox().width),
                                        (n = null),
                                        I - J < m && 1 === g ? ((n = Math.round(J - I + m)), (T[3] = Math.max(n, T[3]))) : I + J > q - m && 0 === g && ((n = Math.round(I + J - q + m)), (T[1] = Math.max(n, T[1]))),
                                        0 > N - L / 2 ? (T[0] = Math.max(Math.round(-N + L / 2), T[0])) : N + L / 2 > t && (T[2] = Math.max(Math.round(N + L / 2 - t), T[2])),
                                        (z.sideOverflow = n));
                                }
                            }
                        }),
            ...
            y.column &&
                (y.column.prototype.alignDataLabel = function (a, c, e, b, f) {
                    ...
                    h &&
                        ...
                        d && (b = { x: g.yAxis.len - b.y - b.height, y: g.xAxis.len - b.x - b.width, width: b.height, height: b.width }),
                ...
                c.visible &&
                    ...
                    ((e = function (c) {
                        return c.forEach(function (c) {
                            c.visible &&
                                (y(c.dataLabels) ? c.dataLabels : c.dataLabel ? [c.dataLabel] : []).forEach(function (e) {
                                    var h = e.options;
        ...
        a.prototype.hideOverlappingLabels = function (a) {
            ...
            var l = function (a) {
                ...
                if (a && (!a.alignAttr || a.placed)) {
                    ...
                    return { x: g.x + (h.translateX || 0) + d - (f || 0), y: g.y + (h.translateY || 0) + d - c, width: a.width - 2 * d, height: a.height - 2 * d };
                }
            };
            ...
            f = (function () {
                ...
                a.prototype.setResponsive = function (a, c) {
                    ...
                    n !== (f && f.ruleIds) &&
                        ...
                        n ? ((f = this.currentOptions(c)), (f.isResponsiveOptions = !0), (this.currentResponsive = { ruleIds: n, mergedOptions: c, undoOptions: f }), this.update(c, a, !0)) : (this.currentResponsive = void 0));
                };
                return a;
            })();
        a = (function () {
